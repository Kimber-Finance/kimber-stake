...
/**
 * @title StakedKimber
 * @notice Contract to stake Kimber token, tokenize the position and get rewards, inheriting from a distribution manager contract
 * @author Aave (modified by Kimber)
 **/
contract MockStakedKimberV2 is IStakedToken, GovernancePowerWithSnapshot, VersionedInitializable, DistributionManager {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string internal constant NAME = "Staked Kimber";
    string internal constant SYMBOL = "stkKIMBER";
